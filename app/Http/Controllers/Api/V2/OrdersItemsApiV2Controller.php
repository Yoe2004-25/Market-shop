...
class OrdersItemsApiV2Controller extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            $filters = $request->only([
                'search', 'price', 'quantity', 'details', 'user_id',
            ]);
            ...
            Log::error('OrdersItemsV2@index: ' . $th->getMessage());
    ...
    public function destroy(string $id): JsonResponse
    {
        try {
            ...
            Log::error('OrdersItems@destroy: ' . $th->getMessage());
